...
def plot_policy_gradient_comparison(grid_step=1000, smooth_window=101, baseline_csv='BaselineDataCartPole.csv'):
    ...
    variants = {
        'REINFORCE':      'Reinforce_default',
        'A2C':            'A2C_default',
        'Actor-Critic':   'AC_1layer_g099_lr001',
        'DQN':            'cartpole_base_ER_TN',}

    colors = {
        'REINFORCE':      'tab:blue',
        'A2C':            'tab:orange',
        'Actor-Critic':   'tab:green',
        'DQN':            'tab:red',}
    ...
    plt.tight_layout()
    plt.savefig('policy_gradient_comparison_steps.png', dpi=300)
    plt.close()
    print("\nSaved 'policy_gradient_comparison_steps.png'")
